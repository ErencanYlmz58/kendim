...
function Question() {
  ...
  const handleSearch = (e) => {
    e.preventDefault()
    if (searchQuery.toLowerCase() === 'ne kadar zamandır birlikteyiz?' || searchQuery.toLowerCase() === 'how long have we been together') {
          navigate("/timer");
       ...
       <div
        ...
        <div className="flex flex-col min-h-screen w-full max-w-[480px] mx-auto ">
          ...
          <div className='mt-10  px-5 text-white/50'>
            <p> "Ne kadar zamandır  birlikteyiz?" yazmayi dene ;)</p>
          </div>
        </div>
      )}
    </div>
