  ...
  <div className="text-center z-10">
    ...
    <div className="flex items-center justify-center gap-3 sm:gap-4 text-5xl sm:text-7xl font-bold mb-6">
      <div className="flex flex-col items-center">
        ...
        <span className="text-sm sm:text-2xl mt-1 sm:mt-2">Gün</span>
      </div>
      <span className="text-4xl sm:text-6xl">:</span>
      <div className="flex flex-col items-center">
        <span className="drop-shadow-lg">{timeLeft.hours.toString().padStart(2, '0')}</span>
        <span className="text-sm sm:text-2xl mt-1 sm:mt-2">Saat</span>
      </div>
      <span className="text-4xl sm:text-6xl">:</span>
      <div className="flex flex-col items-center">
        <span className="drop-shadow-lg">{timeLeft.minutes.toString().padStart(2, '0')}</span>
        <span className="text-sm sm:text-2xl mt-1 sm:mt-2">Dakika</span>
      </div>
      <span className="text-4xl sm:text-6xl">:</span>
      <div className="flex flex-col items-center">
        <span className="drop-shadow-lg">{timeLeft.seconds.toString().padStart(2, '0')}</span>
        <span className="text-sm sm:text-2xl mt-1 sm:mt-2">Saniye</span>
      </div>
    </div>
    <p className=' text-lg mb-8 drop-shadow-lg'>{`... ve hala saymaya devam ediyoruz <3` }</p>
    {/* Button */}
